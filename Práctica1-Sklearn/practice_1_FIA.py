...
"""
SEED = 77687191                             # Random seed. This must be changed to your DNI/Passport number.
...
#FEATURES_TO_USE = ["mean perimeter", "mean smoothness", "mean concave points"]
...
def get_metrics(true_labels, pred_labels):
    ...
    TN = np.count_nonzero(np.logical_not(np.logical_or(true_labels, pred_labels)))
